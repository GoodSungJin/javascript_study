...
function toWeirdCase(str) {
  ...
  for (let i = 0; i < strArr.length; i++) {
    for (let j = 0; j < strArr[i].length; j++) {
      ...
      else if (j % 2 === 1) result += strArr[i][j].toLowerCase();
    }
    result += ' ';
  }
...
전화번호를 나타내는 문자열 str을 입력받는 hideNumbers 함수를 완성하라 예를들어 s가
‘01033334444’면 *******4444를 리턴하고, ‘027778888’인 경우는 *****8888을 리턴한다.
*/
